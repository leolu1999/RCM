...
class ScanNetDataset(utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # imagec_0 = read_scannet_color(img_name0, resize=(640, 480))
        # imagec_1 = read_scannet_color(img_name1, resize=(640, 480))
        ...
        data = {
            ...
            # 'imagec_0': imagec_0,  # (1, h, w, 3)
            # 'imagec_1': imagec_1,  # (1, h, w, 3)
        }
