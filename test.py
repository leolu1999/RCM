...
if __name__ == '__main__':
    ...
    if args.version == 'full':
        model = PL_RCM(config, pretrained_ckpt=args.ckpt_path, profiler=profiler, dump_dir=args.dump_dir)
    elif args.version == 'lite':
        model = PL_RCM_lite(config, pretrained_ckpt=args.ckpt_path, profiler=profiler, dump_dir=args.dump_dir)
    else:
        raise ImportError
